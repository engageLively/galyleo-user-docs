...
![Dashboard View Page](images/view-dashboard.png)

#### View as JSON
Clicking  on the View As JSON button brings up the dashboard as a JSON file.

![Dashboard as JSON](images/view-dashboard-json.png)
...
![File  Chooser](images/file-dialog.png)
...
### Upload Tables
Uploading tables is identical to uploading dashboards save that .sdml files are selected