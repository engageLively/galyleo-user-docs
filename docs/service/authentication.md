...
The same cookie is used for the Service as for the Hub, and so logging into the Hub automatically logs the user into the Galyleo Service.  Logging out of the Hub logs the user out of the Galyleo Service as well.
