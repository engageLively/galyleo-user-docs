...
The service is built on the  foundation of the **Simple Data Transfer Protocol (SDTP)**, an open standard for querying and interacting with structured data. You can read the full SDTP specification [here](https://global-data-plane.github.io/sdtp/build/html/index.html).
...
The SDTP is a data transfer and data-querying protocol.  It is silent on data storage, sharing, and authentication, relying explicitly on implementation choices at hosting siter.  Further, SDTP's only data type is Simple Data Markup Language (SDML) tables.  
...
The service includes a  Web UI for managing data and dashboard  assets. Through the UI, users  easily upload, view, download, and manage sharing permissions for your tables and dashboards.